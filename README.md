...
"sex":"MALE",
    ...
    __id__ is assigned by JPA, __version__ is for optimistic locking.

 2. Keep-Alive: timeout=20
__Location: http://family.danwallacenz.cloudfoundry.me/people/146__
Content-Length: 640

    HTTP Header __Location__ contains the URL of the newly created Person.
 ...
 "title":"Children"
    ...
    __"links"__  attempts to follow recommended RESTful HATEOAS principles.
